      ...
      <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
          <el-form label-width="100px" label-position="left">
              ...
              <el-form-item label="购买时间">
                  <el-date-picker v-model="editItem.createDate" type="datetime" placeholder="选择购买时间"
              ...
              <el-form-item label="数量">
                  ...
                  <el-input-number v-model="editItem.quantity"></el-input-number>
              </el-form-item>
