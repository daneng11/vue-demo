        ...
        <el-dialog class="form" v-model="editDialogVisible" @close="editDialogVisible = false">
            <el-form label-width="100px" label-position="left">
                ...
                <el-form-item label="开始时间">
                    <el-date-picker v-model="editItem.startDate" type="datetime" placeholder="选择开始时间"
                        format="YYYY-MM-DD hh:mm:ss">
                    </el-date-picker>
                </el-form-item>

                <el-form-item label="上下线状态">
                    <el-switch v-model="editItem.status" active-color="#13ce66" inactive-color="#ff4949" :active-value="1"
                        :inactive-value="0">
                    </el-switch>
                </el-form-item>
                ...
                <el-form-item label="创建时间">
                    <el-date-picker v-model="editItem.createTime" type="datetime" placeholder="选择开始时间"
                        format="YYYY-MM-DD hh:mm:ss">
                    </el-date-picker>
                </el-form-item>

                <el-form-item label="结束时间">
                    <el-date-picker v-model="editItem.endDate" type="datetime" placeholder="选择开始时间"
                        format="YYYY-MM-DD hh:mm:ss">
                    </el-date-picker>
                </el-form-item>
            </el-form>
